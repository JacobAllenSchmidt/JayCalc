...
zero_button = Button(root, text="0", padx=40, pady=40, command=lambda: button_click(0))
one_button = Button(root, text="1", padx=40, pady=40, command=lambda: button_click(1))
two_button = Button(root, text="2", padx=40, pady=40, command=lambda: button_click(2))
three_button = Button(root, text="3", padx=40, pady=40, command=lambda: button_click(3))
four_button = Button(root, text="4", padx=40, pady=40, command=lambda: button_click(4))
five_button = Button(root, text="5", padx=40, pady=40, command=lambda: button_click(5))
six_button = Button(root, text="6", padx=40, pady=40, command=lambda: button_click(6))
seven_button = Button(root, text="7", padx=40, pady=40, command=lambda: button_click(7))
eight_button = Button(root, text="8", padx=40, pady=40, command=lambda: button_click(8))
nine_button = Button(root, text="9", padx=40, pady=40, command=lambda: button_click(9))
